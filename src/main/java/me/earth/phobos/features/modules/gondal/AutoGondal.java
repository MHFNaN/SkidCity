...
package me.earth.phobos.features.modules.gondal;
...
import cme.earth.phobos.util.InventoryUtil;
...
public class AutoGondal extends Module
{
    ...
    public AutoGondal() {
        super("AutoGondal", "Best CA on the market", Category.GONDAL, true, false, false);
